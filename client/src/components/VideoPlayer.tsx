          ...
          {hasValidAccess ? (
            ...
            <>
              ...
              <div className="absolute inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-10">
                <div className="text-center text-white p-8" data-testid="locked-overlay">
                  <div className="bg-accent/20 rounded-full p-6 mb-6 inline-block">
                    <Lock className="w-8 h-8 text-accent" />
                  </div>
                  <h3 className="text-2xl font-bold mb-4">Premium Content</h3>
                  <p className="text-lg mb-6">Get 24-hour unlimited access to this video</p>
                  <button
                    onClick={onPaymentRequested}
                    className="px-8 py-4 bg-accent text-accent-foreground rounded-xl font-bold text-lg hover:bg-accent/90 transition-all transform hover:scale-105"
